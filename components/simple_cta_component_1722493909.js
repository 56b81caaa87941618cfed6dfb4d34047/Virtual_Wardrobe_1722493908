...
Vue.component("simple_cta_component_1722493909", {
    ...
    <section id="cta-component" class="bg-gradient-to-br from-pink-500 to-purple-700 flex-1 p-8">
        <div id="cta-inner-container" class="max-w-screen-xl px-8 py-12 mx-auto lg:py-20 lg:px-10 backdrop-blur-xl bg-white/20 rounded-3xl shadow-2xl border border-white/30">
            <div id="cta-content" class="max-w-screen-sm mx-auto text-center">
                ...
                <div id="cta-button-container" class="flex space-x-6">
                    <a id="cta-button" href="#" class="flex-1 text-white bg-gradient-to-r from-pink-400 to-purple-600 hover:from-pink-500 hover:to-purple-700 focus:ring-4 focus:ring-purple-300 font-bold rounded-full text-lg px-8 py-3 transition duration-300 ease-in-out transform hover:scale-105 shadow-lg backdrop-blur-md bg-opacity-70">Explore Now</a>
